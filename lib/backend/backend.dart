...
import 'schema/flowise_messages_record.dart';
...
export 'schema/flowise_messages_record.dart';
...
/// Functions to query FlowiseMessagesRecords (as a Stream and as a Future).
Future<int> queryFlowiseMessagesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<FlowiseMessagesRecord>> queryFlowiseMessagesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FlowiseMessagesRecord.collection,
      FlowiseMessagesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FlowiseMessagesRecord>> queryFlowiseMessagesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
