...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Uploadpdfweblink',
          path: '/uploadpdfweblink',
          builder: (context, params) => UploadpdfweblinkWidget(),
        ),
        FFRoute(
          name: 'uploadpdf',
          path: '/uploadpdf',
          builder: (context, params) => UploadpdfWidget(),
        ),
        FFRoute(
          name: 'chat',
          path: '/chat',
          builder: (context, params) => ChatWidget(
            sessionRef: params.getParam('sessionRef',
                ParamType.DocumentReference, false, ['chat_sessions']),
        ...
        FFRoute(
          name: 'AskWeb',
          path: '/askWeb',
          builder: (context, params) => AskWebWidget(),
        ),
        FFRoute(
          name: 'chatHistory',
          path: '/chatHistory',
