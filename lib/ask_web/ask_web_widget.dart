...
class AskWebWidget extends StatefulWidget {
  const AskWebWidget({Key? key}) : super(key: key);

  @override
  _AskWebWidgetState createState() => _AskWebWidgetState();
}
...
class _AskWebWidgetState extends State<AskWebWidget> {
  ...
  void initState() {
    ...
    _model.urlController ??= TextEditingController(text: 'https://');
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            _model.apiResulth93 = await WebsiteUpsertCall.call(
                              url: _model.urlController.text,
                              namespace:
                                  '${_model.urlController.text}_${currentUserReference?.id}',
                            );
                            if ((_model.apiResulth93?.succeeded ?? true)) {
